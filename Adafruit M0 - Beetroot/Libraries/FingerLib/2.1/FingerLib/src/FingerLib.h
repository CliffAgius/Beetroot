...
// FINGERS
#define MAX_FINGERS		4		// maximum number of fingers
#define F0				0
#define F1				1
#define F2				2
#define F3				3
...
#define POS_REACHED_TOLERANCE		75				// tolerance for posReached()
...
#define window(amt,low,high) ((amt)<(low)?(0):((amt)>(high)?(0):(amt)))		// limit amt to within low and high
	...
	extern Adafruit_DCMotor *mtrs[4];
...
class Finger
{
	public:
		...
		//void printConfig(void);			// print finger number, pins and limitsw
